...
if 'characters' not in st.session_state:
    st.session_state.characters = {
        ...
        # --- PERSONAJE 1: TON (VERSIÓN GUITARRA) ---
        # He añadido al final la frase de que está tocando la guitarra
        ...
        # --- PERSONAJE 1: TON (VERSIÓN MICRO) ---
        # La misma descripción física, pero acabando con el micrófono
        ...
        # --- PERSONAJE 2: FREYA (KAYAK) ---
        # Esta la tenías perfecta, la dejo tal cual
...
# --- LISTAS DEMO ---
DEMO_STYLES = ["Photorealistic 8k", "Cinematic Film Stock", "3D Render (Unreal Engine 5)", "Anime Studio Ghibli Style", "Cyberpunk Noir", "Vintage VHS", "Anime / Manga", 
"3D Render (Octane)", "Oil Painting", "Vintage Film (VHS)", "Claymation", "Pixel Art (8-bit)", "Abstract / Experimental", "Surrealism (Dreamlike)", "Fantasy / RPG", 
"Cyberpunk / Sci-Fi", "Film Noir / B&W", "Watercolor / Ink"]
